...
from .base_classes import  ikea_starkvind_air_purifier_binary_sensor, ikea_motion_sensor, ikea_occupancy_sensor, ikea_light_sensor, ikea_open_close_sensor, ikea_water_sensor
...
async def async_setup_entry(
    ...
    async_add_entities([ikea_occupancy_sensor(x) for x in platform.occupancy_sensors])
    async_add_entities([ikea_light_sensor(x) for x in platform.light_sensors])
